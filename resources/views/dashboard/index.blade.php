                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">Properties Rented</p>
                                <h4 class="mb-0">{{ number_format($propertiesRented) }}</h4>
                            </div>
                            @endif
                        </div>
                        <div class="card-footer p-3">
                            ...
                            @else
                            <p class="mb-0">
                                <span class="text-info text-sm font-weight-bolder">{{ $totalProperties > 0 ? round(($propertiesRented / $totalProperties) * 100, 1) : 0 }}%</span> 
                                of your properties
                            </p>
                            @endif
                        </div>
