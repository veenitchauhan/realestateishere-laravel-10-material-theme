                        ...
                        <form method='POST' action='{{ route('user-profile') }}'>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="password" name="current_password" class="form-control border border-2 p-2" placeholder="Enter current password">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="password" name="new_password" class="form-control border border-2 p-2" placeholder="Enter new password">
                                    @error('new_password')
                                    <p class='text-danger inputerror'>{{ $message }} </p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="password" name="new_password_confirmation" class="form-control border border-2 p-2" placeholder="Confirm new password">
                                    @error('new_password_confirmation')
                                    <p class='text-danger inputerror'>{{ $message }} </p>
                                    @enderror
                                </div>
                            </div>
                            <button type="submit" class="btn bg-gradient-dark">Change Password</button>
                        </form>
