                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header pb-0">
                            <h6 class="mb-0">🏠 Edit Property #{{ $id }}</h6>
                            <p class="text-sm mb-0">Update property information</p>
                        </div>
                        <div class="card-body">
                            @can('edit-properties')
                            <form id="editPropertyForm" autocomplete="off">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-group input-group-outline mb-3 is-filled">
                                            ...
                                            <input type="text" class="form-control" name="property_name" value="Modern Villa" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="input-group input-group-outline mb-3 is-filled">
                                ...
                                <div class="input-group input-group-outline mb-3 is-filled">
                                    ...
                                    <input type="text" class="form-control" name="address" value="123 Oak Street, Beverly Hills" autocomplete="off">
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="input-group input-group-outline mb-3 is-filled">
                                            ...
                                            <input type="number" class="form-control" name="price" value="1250000" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="input-group input-group-outline mb-3 is-filled">
                                            <label class="form-label">Bedrooms</label>
                                            <input type="number" class="form-control" name="bedrooms" value="4" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="input-group input-group-outline mb-3 is-filled">
                                            <label class="form-label">Bathrooms</label>
                                            <input type="number" class="form-control" name="bathrooms" value="3" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="text-center py-4">
                                ...
                                <p class="text-sm text-secondary">You don't have permission to edit properties</p>
                            </div>
                            @endcan
                        </div>
                    </div>
